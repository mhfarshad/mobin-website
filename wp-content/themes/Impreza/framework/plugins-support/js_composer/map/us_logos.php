...
vc_map(
	array(
		...
		'params' => array(
			...
			array(
				'param_name' => 'carousel_autoplay_smooth',
				'type' => 'checkbox',
				'value' => array( __( 'Smooth Rotation', 'us' ) => TRUE ),
				( ( $config['atts']['carousel_autoplay_smooth'] !== FALSE ) ? 'std' : '_std' ) => $config['atts']['carousel_autoplay_smooth'],
				'dependency' => array( 'element' => 'carousel_autoplay', 'not_empty' => TRUE ),
				'group' => __( 'Carousel Settings', 'us' ),
			),
			array(
