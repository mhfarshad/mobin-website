		...
		<?php } else {
			...
			if ( has_action( 'set_comment_cookies', 'wp_set_comment_cookies' ) && get_option( 'show_comments_cookies_opt_in' ) ) {
				$fields['cookies'] = array(
					'type' => 'checkbox',
					'title' => us_translate( 'Save my name and email in this browser for the next time I comment.' ),
			...
			$json_data = array(
				'no_content_msg' => __( 'Please enter a Message', 'us' ),
				'no_name_msg' => __( 'Please enter your Name', 'us' ),
