...
// JSON data
$output .= '<div class="usof-form-row-control-schemes-json hidden"' . us_pass_data_to_js( $color_schemes ) . '></div>';
$output .= '<div class="usof-form-row-control-custom-schemes-json hidden"' . us_pass_data_to_js( $custom_color_schemes ) . '></div>';
