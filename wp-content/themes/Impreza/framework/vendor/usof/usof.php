...
function usof_color_scheme_preview( $scheme ) {
	...
	// Header
	$preview .= '<div class="preview_header" style="background-color:' . $scheme['values']['color_header_middle_bg'] . ';"></div>';
	// Content
	$preview .= '<div class="preview_content" style="background-color:' . $scheme['values']['color_content_bg'] . ';">';
	// Heading
	$preview .= '<div class="preview_heading" style="color:' . $scheme['values']['color_content_heading'] . ';">' . trim( esc_html( $scheme['title'] ) ) . '</div>';
	// Text
	$preview .= '<div class="preview_text" style="color:' . $scheme['values']['color_content_text'] . ';">';
	$preview .= 'Lorem ipsum dolor sit amet, <span style="color:' . $scheme['values']['color_content_link'] . ';">consectetur</span> adipiscing elit. Maecenas arcu lectus, sollicitudin dictum dapibus sit amet.';
	$preview .= '</div>';
	// Primary
	$preview .= '<div class="preview_primary" style="background-color:' . $scheme['values']['color_content_primary'] . ';"></div>';
	// Secondary
	$preview .= '<div class="preview_secondary" style="background-color:' . $scheme['values']['color_content_secondary'] . ';"></div>';
	$preview .= '</div>';
	// Footer
	$preview .= '<div class="preview_footer" style="background-color:' . $scheme['values']['color_footer_bg'] . ';"></div>';
	$preview .= '</div>';
